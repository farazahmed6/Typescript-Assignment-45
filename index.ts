...
console.log(
  `Hello ${personsName2.toLowerCase()}, would you like to learn some python today?`
);
console.log(
  `Hello ${personsName2.toUpperCase()}, would you like to learn some python today?`
);
console.log(
  `Hello ${toTitleCase(
    personsName2
  )}, would you like to learn some pyhton today?`
);
...
console.log("\n");
const names: string[] = ["Faraz", "Ali", "hamzah", "arfah", "abdul"];
...
const guestList: string[] = ["Faraz", "Qaseem", "Arfah", "Ali"];

guestList.forEach((person) => {
  console.log(
    `Dear ${person} You are invited to Dinner. We would be honour to have you!`
  );
});
...
guestList.forEach((person) => {
  console.log(
    `Dear ${person}, you are invited to dinner. We would be honored to have you.`
  );
});
...
for (let i = 0; i < new_users.length; i++) {
  ...
  if (isTaken) {
    console.log(
      `The username "${new_users[i]}" is not available. Please choose a different one.`
    );
  } else {
...
function make_shirt(size: any, message: any) {
  console.log(
    `The shirt is size ${size} and it has the message: "${message}".`
  );
}
...
// Create an array of magicians.
const originalMagicians: string[] = ["Alice", "Bob", "Charlie"];
